//1.A toy manufacturing company manufactures different types of toys. The company has several manufacturing plants. 
//Each plant manufactures different types of toys. A customer can place the order for these toys. Each order may contain one or more toys. Each customer has multiple ship-to addresses. 
//To promote the business, the company offers different schemes based on the order value. use Store procedure

//Define Relationship and do crud operation customer, customer can view all the products and search the record 
//and place an order.

using Day_12_13.Models;
